    ...
    return (
      <div className="flex min-h-[calc(100vh-4rem-2.5rem)] justify-center items-center">
        <div className="text-center p-6 bg-error-100 rounded-lg max-w-md">
          ...
          <Boton tipo="primario" onClick={() => window.location.reload()}>
            Intentar de nuevo
          </Boton>
        </div>
      </div>
            ...
            <InfoTooltip
              ...
              detailContent={[
                ...
                },
                {
                  ...
                  description:
                    "Cada presupuesto tiene una fecha de inicio y fin. Puedes crear presupuestos semanales, mensuales o personalizados.",
                },
                {
          ...
          {presupuestosExpirados.length === 0 ? (
            <div className="bg-white rounded-lg shadow-sm p-8 text-center">
              ...
              <p className="text-neutral-600">
                No tienes presupuestos expirados
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {presupuestosExpiradosOrdenados.map((presupuesto) => {
                const diasExpirado = calcularDiasExpirado(
                  presupuesto.fecha_fin
                );
                const porcentajeProgreso = Math.min(
                  100,
                  ...
                  >
                    <div className="p-4 border-b border-neutral-200">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <span className="text-sm font-medium px-2 py-1 rounded-full bg-neutral-200 text-neutral-700">
                          Expirado
                        </span>
                      </div>
